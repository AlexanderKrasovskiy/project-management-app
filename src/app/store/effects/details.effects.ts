...
import { BoardResModel } from 'src/app/details/models/details-api.model';
import { DetailsErrorHandlerService } from 'src/app/details/services/details-error-handler.service';
